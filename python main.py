...
# Aiogram setup
BOT_TOKEN = "7390503914:AAH3611dk8xP-gAE3Iq5gSPjsO2xqAx-coI"   # Replace this BOT_TOKEN
...
default_limit = 100000  # Max limit for any user
admin_limit = 500000    # Max limit for admin users
...
async def scr_cmd(message: types.Message):
    ...
    if len(args) < 1 or len(args) > 2:
        await bot.send_message(message.chat.id, "<b>𝙷𝚎𝚕𝚕𝚘 𝚝𝚑𝚎𝚛𝚎! 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝙲𝚌_𝚂𝚌𝚛𝚊𝚙𝚙𝚎𝚍_𝚟1 𝚃𝚢𝚙𝚎 /cmds 𝙵𝚘𝚛 𝙰𝚕𝚕 𝙾𝚏 𝙼𝚢 𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜 ✨</b>", parse_mode='html')
        return
...
async def scr_cmd(message: types.Message):
    args = message.text.split()[1:]
    if len(args) < 1 or len(args) > 2:
        await bot.send_message(message.chat.id, "<b>𝚃𝚑𝚎𝚜𝚎 𝙰𝚛𝚎 𝚃𝚑𝚎 𝙱𝚘𝚝 𝙲𝚘𝚖𝚖𝚊𝚗ds            𝚄𝚜𝚊𝚐𝚎: /scr 𝚞𝚜𝚎𝚛𝚗𝚊𝚖𝚎 𝚊𝚖𝚘𝚞𝚗𝚝✨            𝚄𝚜𝚊𝚐𝚎: /scr 𝚞𝚜𝚎𝚛𝚗𝚊𝚖𝚎 𝚊𝚖𝚘𝚞𝚗𝚝 𝚋𝚒𝚗✨            𝚆𝚎 𝚆𝚒𝚕𝚕 𝙱𝚎 𝙰𝚍𝚍𝚒𝚗𝚐 𝚂𝚘𝚖𝚎 𝙶𝚊𝚝𝚎𝚠𝚊𝚢𝚜 𝙰𝚗𝚍 𝚃𝚘𝚘𝚕𝚜 𝚂𝚘𝚘𝚗✨</b>", parse_mode='html')
        return
